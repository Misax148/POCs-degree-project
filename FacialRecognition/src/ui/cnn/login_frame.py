...
class LoginFrameCNN(ttk.Frame):
    """
    Frame for user login using facial recognition.
    ...
    def setup_ui(self):
        ...
        self.photo_label = ttk.Label(photo_frame, text="No se selecciono ninguna foto")
    ...
    def verify_identity(self):
        ...
        # Detect face in the image using hybrid approach
